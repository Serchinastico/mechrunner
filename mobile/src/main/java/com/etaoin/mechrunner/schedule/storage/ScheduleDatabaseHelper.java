...
public class ScheduleDatabaseHelper extends SQLiteOpenHelper {
	...
	private static final String SQL_CREATE_ENTRIES =
			"CREATE TABLE " + ScheduleContract.ScheduleEntry.TABLE_NAME + " (" +
					...
					ScheduleContract.ScheduleEntry.COLUMN_NAME_REPETITONS_COUNT + TEXT_TYPE +
					" )";
	...
	public void insert(Schedule schedule) {
		...
		values.put(ScheduleContract.ScheduleEntry.COLUMN_NAME_REPETITONS_COUNT,
	...
	public List<Schedule> getAll() {
		...
		String[] projection = {
				...
				ScheduleContract.ScheduleEntry.COLUMN_NAME_REPETITONS_COUNT
		};
